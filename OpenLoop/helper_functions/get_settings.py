...
def get_settings(flexop_model, flow, dt, **kwargs):
    ...
    num_cores = kwargs.get('num_cores', 8)  # Number of CPU cores
    ...
    # Add AeroGridPlot settings
    settings['AeroGridPlot'] = {
        'folder': flexop_model.output_route,
        'include_rbm': 'on',
        'include_applied_forces': 'on',
        'include_tstep_gamma': 'on',
        'include_tstep_grids': 'on',
        'include_unsteady_forces': 'on',
        'format': 'mat',
    }
