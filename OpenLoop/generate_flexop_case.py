...
def generate_flexop_case(u_inf,
                         ...
                         cs_deflections=None,
                         **kwargs):
    print("Generating FLEXOP case with the following parameters:")
    print(f"u_inf: {u_inf}, rho: {rho}, alpha: {initial_trim_values['alpha']}, thrust: {initial_trim_values['thrust']}")
    print(f"Control surface deflections: {cs_deflections}")
    ...
    # Initialize the aero model with control surface deflections
    ...
    if gust_settings['use_gust']:
        gust_settings['gust_offset'] *= dt * u_inf
    ...
    settings = get_settings(flexop_model,
                            ...
                            postprocessors_dynamic=kwargs.get('postprocessors_dynamic', ['BeamLoads', 'SaveData', 'BeamPlot', 'AerogridPlot']),
